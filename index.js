...
app.all('/searchItemMatches', (req, res) => {
    ...
    console.log("Just got a request!")
    const responseData = [
        {"searchItem": "123", "title": "TestMatch1", "price": "100", "description": "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknow", "platform": "Tutti", "url": "www.tutti.ch"},
